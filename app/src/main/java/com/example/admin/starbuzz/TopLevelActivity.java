...
private SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            favouriteCursor = db.query("DRINK", new String[] { "_id" ,"NAME"}, "FAVOURITE = 1", null , null, null, null);
            CursorAdapter favouriteAdapter = new SimpleCursorAdapter(TopLevelActivity.this, android.R.layout.simple_list_item_1, favouriteCursor, new String[]{"NAME"},
        ...
        // Navigate to DrinkActivity if the drink name is clicked
